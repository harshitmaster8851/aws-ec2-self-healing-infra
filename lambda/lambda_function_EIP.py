...
def lambda_handler(event, context):
    ...
    # Step 1: Launch replacement instance
    ...
    # Step 4: Attach Elastic IP to new instance
    try:
        ec2.associate_address(
            InstanceId=new_id,
            AllocationId=EIP_ALLOCATION_ID
        )
        print(f" Elastic IP {EIP_ALLOCATION_ID} attached to {new_id}")
    except Exception as e:
        print(f" Failed to attach Elastic IP: {str(e)}")
